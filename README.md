...
Готово — входящие сообщения MAX начнут приходить в Telegram.
...
Создайте Telegram-супергруппу, включите **Темы**, добавьте бота админом с правом
управлять темами и пропишите в `config.json`:
